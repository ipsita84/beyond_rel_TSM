...
%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure*}[]
\subfigure[]{\includegraphics[width= 0.3 \textwidth]{fig2a}} \quad \vrule
\subfigure[]{\includegraphics[width= 0.3 \textwidth]{fig2b}}\quad \vrule
\subfigure[]{\includegraphics[width= 0.31 \textwidth]{fig2c}} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure*}[]
\subfigure[]{\includegraphics[width= 0.3 \textwidth]{fig3a}} \quad \vrule
\subfigure[]{\includegraphics[width= 0.3 \textwidth]{fig3b}} \quad \vrule
\subfigure[]{\includegraphics[width= 0.305 \textwidth]{fig3c}} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure*}[]
\subfigure[]{\includegraphics[width= 0.3 \textwidth]{fig4a}} \quad \vrule
\subfigure[]{\includegraphics[width= 0.3 \textwidth]{fig4b}}\quad \vrule
\subfigure[]{\includegraphics[width= 0.3 \textwidth]{fig4c}}  
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure*}[]
\subfigure[]{\includegraphics[width= 0.3 \textwidth]{fig5a}} \quad \vrule
\subfigure[]{\includegraphics[width= 0.3 \textwidth]{fig5b}} \quad \vrule
\subfigure[]{\includegraphics[width= 0.3 \textwidth]{fig5c}} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure*}[]
\subfigure[]{\includegraphics[width= 0.6 \textwidth]{fig6a}} 
\subfigure[]{\includegraphics[width= 0.9 \textwidth]{fig6b}} 
