...
= \varepsilon_ s  (\boldsymbol k) + \varepsilon_{\chi, s}^{ (m) }  (\boldsymbol k) \, ,\quad 
...
\int_k	\left[ {\mathcal D}_{\chi, s}  ({\boldsymbol k}) \right ]^{-1}
